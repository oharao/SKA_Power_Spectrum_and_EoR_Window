...
def get_antenna_pos():
    ...
    station_pos = pd.read_csv('/home/osdo2/SKA_Power_Spectrum_and_EoR_Window/End-2-End/antenna_pos/layout_wgs84.txt',
    ...
    for i, x, y in zip(range(512), station_pos['x'], station_pos['y']):
        df = pd.read_csv('/home/osdo2/SKA_Power_Spectrum_and_EoR_Window/End-2-End/antenna_pos/station' +

...
def Ts2T21(data_path,sim_name,redshift):
    ...
    Ts_filename = 'Ts_' + str(redshift) + sim_name + '.mat';
...
N_pix, Dc_pix):
    ...
    for k in range(N_final):
        ...
        data = T21_slices[position] + (final_z_values[k]%1)*gradient_in_z[position]
        + 2725 #CMB in mK
...
#----------------------------------------------------------------------------#
    ...
    data_path = 'C:/Users/oscar/OneDrive/Desktop/OSKAR_data/21cmBiBox/'
